...
window.SITE = {
  ...
  promo3: {
    ...
    badge: "SOON · 발표 예정",
    text: "<b>ICECCME 2026</b><span class=\"pp-lead2\">논문 발표 예정</span><span class=\"pp-dash\">—</span><span class=\"pp-title\">시공간 그래프 신경망 기반 예측적 부하 분산 시뮬레이션</span><span class=\"pp-soon\">발리·인도네시아 · 2026.10.15–17</span>",
    cta: "논문 보기 →"
  },
...
window.WORKS = {
  ...
  /* ======================= 포트폴리오 ======================= */
  portfolio: [
    { slug:"pf-site-eeecs", cat:"웹 · 서비스", order:24, title:"EEECS 국제학회 웹사이트", period:"2022–2024", org:"IC-EEECS (오사카)", cover:"assets/img/portfolio/site-eeecs.jpg", tags:["웹","학회"], links:{ url:"https://ic-eeecs.org" }, desc:["전기·전자·컴퓨터공학 국제학회(EEECS) 공식 웹사이트 제작. 등록·결제 안내, 논문 투고 절차, 프로그램 페이지 포함."] },
    ...
    { slug: "pf-waterpipe", cat: "AI · R&D", order: 28,
    ...
    { slug: "pf-khnp-forecast", cat: "AI · R&D", order: 23,
      title: "원전 발전량 예측 (한수원)",
    ...
    { slug: "pf-mmwave-monitoring", cat: "AI · R&D", order: 31,
    ...
    { slug: "pf-drone-cv-damage", cat: "AI · R&D", order: 7,
    ...
    { slug: "pf-digital-signage", cat: "시스템 · 임베디드", order: 6,
    ...
    { slug: "pf-smart-mirror", cat: "AI · R&D", order: 8,
      title: "스마트미러 비접촉 생체신호 측정",
      period: "2023", org: "언택트 의료 R&D",
    ...
    { slug: "pf-3d-audio-ip", cat: "시스템 · 임베디드", order: 5,
    ...
    { slug: "pf-conference-payment", cat: "웹 · 서비스", order: 18,
      title: "학회 결제 시스템",
      period: "2024", org: "학술 행사 등록·결제",
    ...
    { slug: "pf-paper-submission", cat: "웹 · 서비스", order: 17,
      title: "논문 투고 시스템",
      period: "2024", org: "학술 논문 접수",
    ...
    { slug:"pf-incheon-parking-nav", cat:"실내측위 · 내비", order:29,
    ...
    { slug:"pf-firefighter-sim", cat:"시뮬레이션 · XR", order:22,
    ...
    { slug:"pf-eyedrive", cat:"도구 · 라이브러리", order:21,
    ...
    { slug:"pf-indoor-nav-frontend", cat:"실내측위 · 내비", order:16,
    ...
    { slug:"pf-indoor-route-php", cat:"실내측위 · 내비", order:15,
    ...
    { slug:"pf-geojson-nodenet", cat:"실내측위 · 내비", order:14,
      ...
      figs:[{src:"assets/portfolio/pf-geojson-nodenet/02-geojson-structure.jpg", cap:"입력 GeoJSON 데이터 구조(링크 정보 없음)"},{src:"assets/portfolio/pf-geojson-nodenet/03-nodenet-json.jpg", cap:"변환 결과 노드망 JSON 구조(경로탐색 가능)"}],
      desc:["GeoJSON은 선(line) 간 링크 정보가 없어 경로탐색에 바로 쓸 수 없다. 이 도구는 GeoJSON을 최단경로 탐색이 가능한 노드망 JSON으로 변환해 실내·외 내비게이션 모듈의 전처리를 담당한다."] },
    { slug:"pf-medical-compress-fw", cat:"시스템 · 임베디드", order:13,
    ...
    { slug:"pf-seq2seq-watertemp", cat:"AI · R&D", order:12,
    ...
    { slug:"pf-coding-textutil", cat:"도구 · 라이브러리", order:11,
    ...
    { slug:"pf-rtsp-viewer", cat:"시스템 · 임베디드", order:10,
      title:"RTSP 스트림 뷰어",
      period:"2023", org:"GitHub · C#/.NET WinForm",
    ...
    { slug:"pf-archive-its", cat:"웹 · 서비스", order:9,
  ...
  { src:"assets/img/activity/event-yeokjeon-vice-minister-demo.jpg", title:"역전지하상가 실내 내비게이션 시연 (행안부 차관)", date:"2024.04", tag:"시연", desc:"대전 역전지하상가 주소기반 실내내비게이션 성과보고회에서 행정안전부 차관에게 현장 시연" },
  { src:"assets/img/activity/event-gimhae-airport-field-test.jpg", title:"김해공항 지능형 방역플랫폼 현장 실증", date:"2024.05", tag:"현장실증", desc:"김해공항에서 진행된 지능형 방역플랫폼(방역터널·수하물 방역기) 현장 실증" },
