...
window.WORKS = {
  ...
  publications: [
    ...
    /* --- 국제학술대회 --- */
    {
      ...
      sum: [
        "미시교통 디지털트윈을 실현하려면 도로망을 여러 워커 노드로 분할하는 분산 시뮬레이션이 필요하다. 사실상 표준인 정적 그래프 분할(METIS 등)은 기하·위상 정보만으로 분할을 한 번 결정하므로 통근 누적·돌발 사고처럼 시간에 따라 변하는 연산 부하를 반영하지 못해, 동기화 단계마다 가장 부하가 큰 워커가 전체 속도를 좌우하는 동적 부하 불균형이 발생한다.",
        "제안하는 predict-then-partition 방식은 시공간 그래프 신경망(ST-GNN)이 다음 시간 구간의 링크별 연산 부하를 예측하고, 이 예측값을 노드 가중치로 삼아 불균형이 발생하기 전에 도로망을 선제적으로 재분할한다. KAIST NextSim 엔진의 파이썬 포트인 PySim과 대한민국 부천 도로망(330개 링크)의 실제 링크별 부하 트레이스로 검증했다.",
        "예측적 분할은 정적 기하 분할 대비 부하 불균형 지표 λ를 K=8에서 65%, K=2~16 전 구간에서 49~67% 낮추면서 통신 컷은 거의 그대로 유지했다. 학습된 ST-GNN 예측기는 미래 부하를 아는 Oracle에 근접한 균형을 달성했고, 단순 persistence 예측기의 피크 불균형을 0.78에서 0.30으로 낮췄다."
      ],
      why: "정적 분할이 담지 못하는 '시간에 따라 변하는 연산 부하'를 예측해 선제적으로 재분할함으로써, 분산 미시교통 시뮬레이션의 동적 부하 불균형을 구조적으로 줄인다."
    },
    {
      ...
      venue: "APCC 2024 (Bali)", date: "2024.11.05–07", role: "주저자",
    ...
    { slug: "ictc2023-seq2seq-temp", kind: "국제학술", order: 2023.101,
      ...
      venue: "ICTC 2023", date: "2023.10.11–13", role: "주저자",
    ...
    { slug: "ictc2023-electricity-demand", kind: "국제학술", order: 2023.102,
      ...
      venue: "ICTC 2023", date: "2023.10.11–13", role: "공동저자(제2저자)",
    ...
    { slug: "iaser-multiturn-weather", kind: "국제학술", order: 2022.121,
      ...
      venue: "EEECS 2022", date: "2022.07.20–22", role: "주저자",
    ...
    { slug: "iaser-emotion-chatbot", kind: "국제학술", order: 2021.071,
      ...
      venue: "EEECS 2021", date: "2021.07.21–23", role: "주저자",
    ...
    { slug: "iaser-contactless-mirror", kind: "국제학술", order: 2020.121,
      ...
      venue: "EEECS 2020", date: "2020.12.21–22", role: "공동저자(제3저자)",
    ...
    { slug: "iaser-ml-signage", kind: "국제학술", order: 2020.122,
      ...
      venue: "EEECS 2020", date: "2020.12.21–22", role: "주저자",
    ...
    { slug: "iaser-proxy-signage", kind: "국제학술", order: 2020.123,
      ...
      venue: "EEECS 2020", date: "2020.12.21–22", role: "공동저자(제2저자)",
    ...
    /* --- 국내학술 --- */
    { slug: "dcs2026-indoor-network-tool", kind: "국내학술", order: 2026.07,
      title: "실내이동경로 정량적인 생성을 위한 실내 이동 네트워크 도구 개발 연구",
      titleEn: "Development of an Indoor Movement Network Tool for Quantitative Indoor Route Generation",
      venue: "한국디지털콘텐츠학회 2026 하계종합학술대회 (제주, 오션스위츠 제주호텔) · 발표번호 A7-04",
      date: "2026.07.01–03", role: "공동저자(제2저자)",
      award: "우수논문상 (일반)",
      links: {},
      tags: ["실내 이동 네트워크", "IndoorGML", "GIS"],
      sum: [
        "노드-링크 기반 실내 이동 네트워크는 그동안 상당 부분 수작업에 의존해, 동일 공간에서도 작성자에 따라 결과가 달라지고 정량적 재현이 어려웠다. 본 연구는 SHP 기반 실내공간을 정량적으로 분할하고 네트워크를 자동 생성·편집하는 도구로 이 한계를 다룬다.",
        "제안 시스템은 PyQt5·GeoPandas·Shapely를 기반으로 회전 보정 공간분할, 격자 중심 연결 방식과 자유 좌표 연결 방식의 네트워크 생성·분할, 속성 편집, SHP 저장 기능을 제공하는 GUI 도구다.",
        "공공기관 등 13개 실내공간 데이터에 적용해 동일 환경에서 공간분할과 네트워크 작성이 가능함을 확인했으며, IndoorGML 구축을 위한 기초 공간자료 작성 도구로 활용할 수 있다."
      ],
      why: "실내 이동 네트워크 구축의 수작업 한계를 SHP 기반 정량 분할과 GUI 자동화로 해소해, IndoorGML 등 실내 공간정보 표준 구축의 기초 자료 작성을 지원한다." },
